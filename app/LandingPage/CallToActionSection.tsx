      ...
      <div className="grid grid-cols-2 gap-8 items-center">
        ...
        <div>
          ...
          <p className="text-gray-700 mb-6">
            Our standout features is its commitment to fair pricing. Our
            platform offers competitive fees for sellers, ensuring that they can
            maximize their profits without hidden costs.
          </p>
